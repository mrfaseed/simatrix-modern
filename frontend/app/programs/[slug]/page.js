      ...
      <div className="container">
        ...
        <div style={{
          ...
          <div>
            ...
            <h1 style={{ fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 800, color: "var(--text-primary)", marginBottom: "20px" }}>
              {program.title}
            </h1>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: "1rem", color: "var(--text-primary)", marginBottom: "14px" }}>What Makes This Program Different:</h3>
          ...
          <Card style={{ position: "sticky", top: "100px", padding: "30px" }}>
            ...
            <div style={{ fontSize: "1.6rem", fontWeight: 800, color: "var(--text-primary)", marginBottom: "16px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginBottom: "24px", fontSize: "0.9rem" }}>
              <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid var(--border-subtle)", paddingBottom: "8px" }}>
                ...
                <span style={{ color: "var(--text-primary)", fontWeight: 600 }}>{program.duration}</span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid var(--border-subtle)", paddingBottom: "8px" }}>
                <span style={{ color: "var(--text-muted)" }}>Format:</span>
                <span style={{ color: "var(--text-primary)", fontWeight: 600 }}>{program.mode}</span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid var(--border-subtle)", paddingBottom: "8px" }}>
                <span style={{ color: "var(--text-muted)" }}>Prerequisites:</span>
                <span style={{ color: "var(--text-primary)", fontWeight: 600 }}>{program.level}</span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid var(--border-subtle)", paddingBottom: "8px" }}>
        ...
        <div style={{ maxWidth: "840px" }}>
          <h2 style={{ fontSize: "2rem", fontWeight: 800, color: "var(--text-primary)", marginBottom: "24px" }}>
